...
@section('subcontent')
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 lg:col-span-6 mt-6">
                    <div class="intro-y block sm:flex items-center sm:h-10">
                        ...
                        <button class="ml-3 btn box flex items-center text-slate-600 dark:text-slate-300">
                            <i data-lucide="file-text" class="hidden sm:block w-4 h-4 mr-2"></i> Generar Estadisticas
                        </button>-->
                    </div>
                            ...
                            <div class="box sm:flex">
                                <div class="p-8 flex flex-col justify-center flex-1">
                                    ...
                                    <div class="flex items-center mt-[67px]">
                                        <div class="relative text-2xl font-medium">{{ $total }}</div>
                                        <div class="report-box-2__indicator text-success tooltip cursor-pointer" title="{{"+".$ultimo_mes_total." titulados este mes"}}">
                                            +{{ $ultimo_mes_total}} <i data-lucide="arrow-up" class="w-4 h-4 ml-0.5"></i>
                                        </div>
                                    </div>
                                    <div class="leading-relaxed mt-2 text-slate-500 dark:text-slate-500">Total de Alumnos Titulados</div>
                                        ...
                                        <div class="dropdown-menu w-full">
                                            <div class="dropdown-content">
                                                <a href="" class="dropdown-item">
                                                    <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Reporte Mensual
                                                </a>
                                                <a href="" class="dropdown-item">
                                                    <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Reporte Anual
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="p-8 flex flex-col justify-center flex-1 border-t sm:border-t-0 sm:border-l border-slate-200 border-dashed">
                                    <div class="text-slate-500">División de Ciencias Básicas</div>
                                    <div class="mt-1.5 flex items-center">
                                        <div class="text-base">{{ $division1 }}</div>
                                        <div class="text-success flex items-center text-xs tooltip cursor-pointer ml-2" title="{{"+".$ultimo_mes1." titulados este mes"}}">
                                            +{{ $ultimo_mes1 }} <i data-lucide="arrow-up" class="w-3 h-3 ml-0.5"></i>
                                        </div>
                                    </div>
                                    <div class="text-slate-500 mt-6 xl:mt-7">División de Ingenierías</div>
                                    <div class="mt-1.5 flex items-center">
                                        <div class="text-base">{{ $division2 }}</div>
                                        <div class="text-success flex items-center text-xs tooltip cursor-pointer ml-2" title="{{"+".$ultimo_mes2." titulados este mes"}}">
                                            +{{ $ultimo_mes2 }} <i data-lucide="arrow-up" class="w-3 h-3 ml-0.5"></i>
                                        </div>
                                    </div>
                                    <div class="text-slate-500 mt-6 xl:mt-7">DIVTIC</div>
                                    <div class="mt-1.5 flex items-center">
                                        <div class="text-base">{{ $division3 }}</div>
                                        <div class="text-success flex items-center text-xs tooltip cursor-pointer ml-2" title="{{"+".$ultimo_mes3." titulados este mes"}}">
                                            +{{ $ultimo_mes3 }} <i data-lucide="arrow-up" class="w-3 h-3 ml-0.5"></i>
                                        </div>
                                    </div>                                   
                                </div>
                            </div>
                ...
                <div class="col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-3 mt-4 lg:mt-6">
                    <div class="intro-y flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">Gráficas</h2>
                    ...
                    <div class="report-box-2 intro-y mt-4">
                        <div class="box p-5">
                            <div class="px-3">
                                <div class="w-40 mx-auto lg:w-auto">
                                    <div class="h-[190px]">
                                        <canvas class="mt-3 z-10 relative" id="grafica1"></canvas>
                                    </div>
                                </div>
                            </div>
                            <div class="w-52 lg:w-auto mx-auto mt-8">
    ...
    <script>
        var estadistica1 = "{{$estadistica1}}";
        var estadistica2 = "{{$estadistica2}}";
        var estadistica3 = "{{$estadistica3}}";
        var data = {
            //: ['DIVCB', 'DIVING', 'DIVTIC'],
            datasets: [
                {
                    data: [estadistica1, estadistica2, estadistica3], // Porcentajes
                    backgroundColor: ['rgb(45 60 90 / .5)', 'rgb(249 115 22 / .5)', 'rgb( 245 158 11 / .5)'] 
                }
            ]
        };        
        ...
        var doughnutChart = new Chart(ctx2, {
            type: 'doughnut',
            options:{maintainAspectRatio:!1,plugins:{legend:{display:!1}},cutout:"90%"},
            data: data
        });
    </script>
@endsection
