        ...
        <!--can('admin-coordinador')                  -->            
            <div class="form-inline">
                ...
                @can('admin-coordinador')                        
                    ...
                    <!-- Boton de Eliminar -->
                    <div class="btn-group mr-2">
                        <a id="eliminar" class="btn btn-danger btn-icon-split" href="javascript:;" data-tw-toggle="modal" data-target="#eliminarTramiteModal">
