...
@section('head')
    <title>Error Page - Rocketman - Tailwind HTML Admin Templatee</title>
@endsection
    ...
    <div class="container">
        ...
        <div class="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
            <div class="-intro-x lg:mr-20">
                <img alt="Rocketman - HTML Admin Template" class="h-48 lg:h-auto" src="{{ asset('build/assets/images/error-illustration.svg') }}">
            </div>
