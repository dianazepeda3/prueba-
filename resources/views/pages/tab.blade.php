...
@section('subhead')
    <title>Tab - Rocketman - Tailwind HTML Admin Templatee</title>
@endsection
    ...
    <div class="intro-y grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5">
                    Rocketman’s tab class exposes a few events for hooking into tab functionality. All tab events are fired at the tab itself (i.e. at the <span class="text-red-500">&lt;div class="nav"&gt;</span>).
                    <table class="table">
                        <thead>
                            <tr>
