...
@section('subhead')
    <title>Accordion - Rocketman - Tailwind HTML Admin Template</title>
@endsection
    ...
    <div class="intro-y grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5">
                    Rocketman’s accordion class exposes a few events for hooking into accordion functionality. All accordion events are fired at the accordion itself (i.e. at the <span class="text-red-500">&lt;div class="accordion"&gt;</span>).
                    <table class="table">
                        <thead>
                            <tr>
