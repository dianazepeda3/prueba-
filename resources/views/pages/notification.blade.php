...
@section('subhead')
    <title>Notification - Rocketman - Tailwind HTML Admin Templatee</title>
@endsection
                        ...
                        <div class="text-center">
                            ...
                            <div id="notification-with-avatar-content" class="toastify-content hidden flex">
                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                    <img alt="Rocketman - HTML Admin Templateate" src="{{ asset('build/assets/images/' . $fakers[0]['photos'][0]) }}">
                                </div>
